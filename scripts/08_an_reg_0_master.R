...
coef_labs <- c(
  ...
  "jury_groupfemale" = "Jury female dominated (ref. even)",
  "jury_groupmale" = "Jury male dominated (ref. even)",
  ...
  # "jury_preferencefemale to male" = "Female jury, male winner (ref. even jury)",
  # "jury_preferencemale to female" = "Male jury, female winner (ref. even jury)",
  # "jury_preferencemale to male" = "Male jury, male winner (ref. even jury)",
  # "metooAfter #metoo:jury_preferencefemale to female" =
  #   "Female jury, female winner x After #metoo",
  # "metooAfter #metoo:jury_preferencefemale to male" =
  #   "Female jury, male winner x After #metoo",
  # "metooAfter #metoo:jury_preferencemale to female" =
  #   "Male jury, female winner x After #metoo",
  # "metooAfter #metoo:jury_preferencemale to male" =
  #   "Male jury, male winner x After #metoo"
)
...
model_formulars <- c(
  ...
  "Jury" = winner ~ female * jury_group + debut, # metoo * jury_preference
  "Full Model" = winner ~ revs_n_cat + senti_qual_cat +
    ...
    female * jury_group + debut + nonfiction # metoo * jury_preference
)
